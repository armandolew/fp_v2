...
class BottlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bottle" do
    assert_difference('Bottle.count') do
      post bottles_url, params: { bottle: { bottle_type_id: @bottle.bottle_type_id, name: @bottle.name } }
    end
  ...
  test "should update bottle" do
    patch bottle_url(@bottle), params: { bottle: { bottle_type_id: @bottle.bottle_type_id, name: @bottle.name } }
